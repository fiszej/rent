...
<form action="index.php?admin=add-customer" method="POST">
    <div class="mb-3">
        ...
        <input type="text" class="form-control form-control-sm" value="<?= $row->firstname ?>" name ="firstname" autocomplete="off">
        <small class="text-danger"><?= $error['firstname'];?></small>
    </div>
    <div class="mb-3">
        <label for="exampleFormControlInput1" class="form-label">Lastname</label>
        <input type="text" class="form-control form-control-sm" value="<?= $row->lastname ?>" name ="lastname" autocomplete="off">
        <small class="text-danger"><?= $error['lastname'];?></small>
    </div>
    <div class="mb-3">
        <label for="exampleFormControlInput1" class="form-label">Email</label>
        <input type="text" class="form-control form-control-sm" value="<?= $row->email ?>" name ="email" autocomplete="off">
